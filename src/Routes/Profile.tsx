                     ...
                     {orders.map((order, i) => {
                        return (
                           ...
                           >
                              ...
                              <div className="orderStatus">Order Status: {order.currentStatus}</div>
                              <div className="info">
                                 <div className="date">
                                    {new Date(order.timestamps[order.currentStatus]).toLocaleString()}
                                 </div>
                                 <div className="items">{Object.keys(order.orderItems).length} items</div>
                              </div>
                           </div>
                        )
                     })}
